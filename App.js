...
form.addEventListener("submit", (event) => {
	...
	fetch(
		`https://api.spoonacular.com/mealplanner/generate?apiKey=7f1c356d65a84b2fa5b5901791ff99d5&timeFrame=day&targetCalories=2000&diet=balanced&height=${height}&weight=${weight}&age=${age}&gender=${gender}&activityLevel=${activityLevel}`
	)
